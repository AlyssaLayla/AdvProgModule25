...
class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        product.setProductName("Bismillah Test");
        ...
        Map <String, String> paymentDataBank = Map.of("bankName", "BANK_KUKEL", "referenceCode", "1234567890");
        Payment payment2 = new Payment("13652556-012a-4c07-b546-54eb1396d79b", "BankTransfer", order, paymentDataBank);
    ...
    void testAddPayment() {
        ...
        Payment result = paymentService.addPayment(order, "VoucherCode", Map.of("VoucherCode", "ESHOP1234ABC5678"));
    ...
    void testSetStatusInvalidStatus() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            paymentService.setStatus(payment, "LOH");
        });
    ...
    void testGetPaymentIfNotFound() {
        doReturn(null).when(paymentRepository).findById("popo");
        assertNull(paymentService.getPayment("popo"));
    }
